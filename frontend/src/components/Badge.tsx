...
const SOURCE_STYLES: Record<BadgeSource, string> = {
  ...
  dnspod: "bg-source-dnspod-bg text-source-dnspod-fg border-transparent",
  alidns: "bg-source-alidns-bg text-source-alidns-fg border-transparent",
  huaweicloud: "bg-source-huawei-bg text-source-huawei-fg border-transparent",
  vercel: "bg-source-vercel-bg text-source-vercel-fg border-transparent",

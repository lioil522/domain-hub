...
import { THEMES, type ThemeId, applyThemeAttribute } from "./theme";
...
export default function DesignSystem() {
  ...
  const [colorTheme, setColorTheme] = useState<ThemeId>(() => {
    ...
    return attr === "inkjade" ? "inkjade" : "indigo";
  });
  ...
  return (
    <div className="min-h-screen bg-page p-4 sm:p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <Section
          title="主题 · 配色身份 × 明暗"
          desc="两个正交维度：配色身份（data-theme）管色相，明暗（.dark 类）管明度。4 个组合各自独立配平，切换任一维度都不影响另一个。"
        >
          <Card padding="lg">
            <div className="mb-4">
            ...
            <p className="text-[11px] text-content-muted mt-4 leading-relaxed">
              ...
              （WCAG 2.1 相对亮度公式，含半透明底色的合成），72 项配对全量跑一遍。
              两套主题 × 明暗共 4 个组合现已<b className="text-content-secondary">全部 ≥ 4.5:1</b>。
        ...
        >
          <Card padding="lg">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <Field label="服务商">
                <select className="form-input px-3 py-2 rounded-md text-sm w-full">
                  <option>DNSHE</option>
                  <option>Cloudflare</option>
                  <option>DigitalPlat</option>
                  <option>自定义</option>
                </select>
              </Field>
            </div>

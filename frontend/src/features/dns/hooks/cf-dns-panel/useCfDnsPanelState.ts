...
export function useCfDnsPanelState() {
  ...
  return {
    ...
    cfBatchResults, setCfBatchResults, cfBatchTextareaRef, cfSelectedKeys, setCfSelectedKeys, cfEditPanelOpen, setCfEditPanelOpen,
    cfEditFields, setCfEditFields, cfBatchEditTtl, setCfBatchEditTtl, cfBatchEditProxied, setCfBatchEditProxied,
    cfBatchEditContents, setCfBatchEditContents, cfEditResults, setCfEditResults,
  };
}
